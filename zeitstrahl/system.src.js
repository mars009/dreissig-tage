        ...
        (function(__global) {
            ...
            */
            ...
            function applyPaths(loader, name) {
                ...
                var pathMatch = '',
                    wildcard, maxWildcardPrefixLen = 0;
            ...
            SystemJSLoader.prototype.config = function(cfg, isEnvConfig) {
                ...
                for (var c in cfg) {
                    ...
                    if (indexOf.call(['baseURL', 'map', 'packages', 'bundles', 'paths', 'warnings', 'packageConfigPaths',
                            'loaderErrorStack', 'browserConfig', 'nodeConfig', 'devConfig', 'buildConfig', 'productionConfig'
                        ], c) != -1)
                        continue;
